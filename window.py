...
class Ui_Window(object):
    def setupUi(self, Window):
        ...
        Window.setMinimumSize(QtCore.QSize(700, 600))
        Window.setMaximumSize(QtCore.QSize(700, 600))
        icon = QtGui.QIcon()
...
"}")
        ...
        self.btn_view.setGeometry(QtCore.QRect(450, 160, 139, 20))
        self.btn_view.setObjectName("btn_view")
        self.widget = QtWidgets.QWidget(self.centralwidget)
        self.widget.setGeometry(QtCore.QRect(100, 10, 281, 220))
        ...
        self.lbl_emp_no = QtWidgets.QLabel(self.widget)
        self.lbl_emp_no.setObjectName("lbl_emp_no")
        self.horizontalLayout.addWidget(self.lbl_emp_no)
        spacerItem = QtWidgets.QSpacerItem(40, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        self.horizontalLayout.addItem(spacerItem)
        self.ln_emp_no = QtWidgets.QLineEdit(self.widget)
        self.ln_emp_no.setClearButtonEnabled(True)
        self.ln_emp_no.setObjectName("ln_emp_no")
        self.horizontalLayout.addWidget(self.ln_emp_no)
        self.verticalLayout.addLayout(self.horizontalLayout)

        self.horizontalLayout_2 = QtWidgets.QHBoxLayout()
        self.horizontalLayout_2.setObjectName("horizontalLayout_2")
        self.lbl_emp_name = QtWidgets.QLabel(self.widget)
        self.lbl_emp_name.setObjectName("lbl_emp_name")
        self.horizontalLayout_2.addWidget(self.lbl_emp_name)
        spacerItem1 = QtWidgets.QSpacerItem(40, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        self.horizontalLayout_2.addItem(spacerItem1)
        self.ln_emp_name = QtWidgets.QLineEdit(self.widget)
        self.ln_emp_name.setClearButtonEnabled(True)
        self.ln_emp_name.setObjectName("ln_emp_name")
        self.horizontalLayout_2.addWidget(self.ln_emp_name)
        ...
        self.ln_song = QtWidgets.QLineEdit(self.widget)
        self.ln_song.setAcceptDrops(True)
        self.ln_song.setInputMethodHints(QtCore.Qt.ImhNone)
        self.ln_song.setInputMask("")
        self.ln_song.setText("")
        self.ln_song.setEchoMode(QtWidgets.QLineEdit.Normal)
        self.ln_song.setCursorPosition(0)
        self.ln_song.setDragEnabled(False)
        self.ln_song.setReadOnly(False)
        self.ln_song.setClearButtonEnabled(True)
        self.ln_song.setObjectName("ln_song")
        self.horizontalLayout_3.addWidget(self.ln_song)
        self.verticalLayout.addLayout(self.horizontalLayout_3)

        self.horizontalLayout_4 = QtWidgets.QHBoxLayout()
        self.horizontalLayout_4.setObjectName("horizontalLayout_4")
        self.lbl_artist = QtWidgets.QLabel(self.widget)
        self.lbl_artist.setObjectName("lbl_artist")
        self.horizontalLayout_4.addWidget(self.lbl_artist)
        spacerItem3 = QtWidgets.QSpacerItem(40, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        self.horizontalLayout_4.addItem(spacerItem3)
        self.ln_artist = QtWidgets.QLineEdit(self.widget)
        self.ln_artist.setInputMethodHints(QtCore.Qt.ImhNone)
        self.ln_artist.setDragEnabled(False)
        self.ln_artist.setReadOnly(False)
        self.ln_artist.setClearButtonEnabled(True)
        self.ln_artist.setObjectName("ln_artist")
        self.horizontalLayout_4.addWidget(self.ln_artist)
        self.verticalLayout.addLayout(self.horizontalLayout_4)

        self.horizontalLayout_5 = QtWidgets.QHBoxLayout()
        self.horizontalLayout_5.setObjectName("horizontalLayout_5")
        self.lbl_duration = QtWidgets.QLabel(self.widget)
        self.lbl_duration.setObjectName("lbl_duration")
        self.horizontalLayout_5.addWidget(self.lbl_duration)
        spacerItem4 = QtWidgets.QSpacerItem(40, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        self.horizontalLayout_5.addItem(spacerItem4)
        self.ln_duration = QtWidgets.QLineEdit(self.widget)
        self.ln_duration.setInputMethodHints(QtCore.Qt.ImhNone)
        self.ln_duration.setDragEnabled(False)
        self.ln_duration.setReadOnly(False)
        self.ln_duration.setClearButtonEnabled(True)
        self.ln_duration.setObjectName("ln_duration")
        self.horizontalLayout_5.addWidget(self.ln_duration)
        self.verticalLayout.addLayout(self.horizontalLayout_5)

        self.horizontalLayout_6 = QtWidgets.QHBoxLayout()
        self.horizontalLayout_6.setObjectName("horizontalLayout_6")
        self.lbl_genre = QtWidgets.QLabel(self.widget)
        self.lbl_genre.setObjectName("lbl_genre")
        self.horizontalLayout_6.addWidget(self.lbl_genre)
        spacerItem5 = QtWidgets.QSpacerItem(40, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        self.horizontalLayout_6.addItem(spacerItem5)
        self.ln_genre = QtWidgets.QLineEdit(self.widget)
        self.ln_genre.setInputMethodHints(QtCore.Qt.ImhNone)
        self.ln_genre.setDragEnabled(False)
        self.ln_genre.setReadOnly(False)
        self.ln_genre.setClearButtonEnabled(True)
        self.ln_genre.setObjectName("ln_genre")
        self.horizontalLayout_6.addWidget(self.ln_genre)
        self.verticalLayout.addLayout(self.horizontalLayout_6)

        self.horizontalLayout_7 = QtWidgets.QHBoxLayout()
        self.horizontalLayout_7.setObjectName("horizontalLayout_7")
        self.lbl_signal_distortion = QtWidgets.QLabel(self.widget)
        self.lbl_signal_distortion.setObjectName("lbl_signal_distortion")
        self.horizontalLayout_7.addWidget(self.lbl_signal_distortion)
        spacerItem6 = QtWidgets.QSpacerItem(40, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        self.horizontalLayout_7.addItem(spacerItem6)
        self.ln_signal_distortion = QtWidgets.QLineEdit(self.widget)
        self.ln_signal_distortion.setInputMethodHints(QtCore.Qt.ImhNone)
        self.ln_signal_distortion.setDragEnabled(False)
        self.ln_signal_distortion.setReadOnly(False)
        self.ln_signal_distortion.setClearButtonEnabled(True)
        self.ln_signal_distortion.setObjectName("ln_signal_distortion")
        self.horizontalLayout_7.addWidget(self.ln_signal_distortion)
        ...
        self.btn_update = QtWidgets.QPushButton(self.widget2)
        self.btn_update.setObjectName("btn_update")
        self.verticalLayout_2.addWidget(self.btn_update)
        self.btn_search = QtWidgets.QPushButton(self.widget2)
    ...
    def retranslateUi(self, Window):
        ...
        Window.setWindowTitle(_translate("Window", "Karaokay Machine"))
        self.btn_view.setText(_translate("Window", "VIEW"))
        self.lbl_emp_no.setText(_translate("Window", "Employee No:"))
        self.lbl_emp_name.setText(_translate("Window", "Employee Name:"))
        self.lbl_adet.setText(_translate("Window", "Song:"))
        self.lbl_artist.setText(_translate("Window", "Artist:"))
        self.lbl_duration.setText(_translate("Window", "Duration:"))
        self.lbl_genre.setText(_translate("Window", "Genre:"))
        self.lbl_signal_distortion.setText(_translate("Window", "Signal Distortion:"))
        self.btn_delete.setText(_translate("Window", "DELETE"))
        self.btn_clear.setText(_translate("Window", "CLEAR"))
        self.btn_exit.setText(_translate("Window", "EXIT"))
        self.btn_save.setText(_translate("Window", "SAVE"))
        self.btn_update.setText(_translate("Window", "UPDATE"))
